...
namespace Zebra.DataStructures
{
    ...
    public class WriteableBuffer
    {
        ...
        {
            if ((index + s.Length + 2) >= length)
                resize();

            writeShort((ushort)s.Length);
            writeString(s);
        }

        /// <summary>
        /// Write a string to the buffer padded on the left
        /// by a given character.
        /// </summary>
        /// <param name="s">the string to be written</param>
        /// <param name="pad">the character to pad with</param>
        /// <param name="len">the length of the pad</param>
        public void writeStringPaddedLeft(string s, char pad, int len)
        {
            s.PadLeft(len, pad);
        ...
        /// <summary>
        /// Write a string to the buffer padded on the right
        /// by a given character.
        /// </summary>
        /// <param name="s">the string to be written</param>
        /// <param name="pad">the character to pad with</param>
        /// <param name="len">the length of the pad</param>
        public void writeStringPaddedRight(string s, char pad, int len)
        {
            s.PadRight(len, pad);
        ...
        /// <summary>
        /// Prints the buffer's data (hex format).
        /// </summary>
