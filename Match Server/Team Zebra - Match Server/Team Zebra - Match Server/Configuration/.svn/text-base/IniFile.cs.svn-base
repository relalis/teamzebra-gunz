...
namespace Zebra.Configuration
{
    ...
    public class IniFile
    {
        ...
        static public void createNewConfig()
        {
            ...
            configCreator.WriteLine("ID=1");
            configCreator.WriteLine();
            configCreator.WriteLine(";The port to listen on");
            configCreator.WriteLine("PORT=6000");
            configCreator.WriteLine();
            configCreator.WriteLine(";Maximum number of players");
            configCreator.WriteLine("MAX USERS=");
            configCreator.WriteLine();
            configCreator.WriteLine(";The name of the server");
            configCreator.WriteLine("NAME=");
            configCreator.WriteLine();
            configCreator.WriteLine(";The type of the server (numerical)");
            configCreator.Write("TYPE=");
